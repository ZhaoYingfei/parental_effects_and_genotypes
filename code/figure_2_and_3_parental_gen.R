...
lmm_fits <- setNames(
  purrr::map(variables, ~ fit_lmm(.x, data_01gen)),
  variables
)
...
write_csv(final_anova_table, "./results/parental.performance.anova.csv")
...
png("./results/parental.plots_qq.png", width = 1600, height = 1200)
grid.arrange(grobs = plots_qq, ncol = 4)
dev.off()

# Arrange plots_resid_fit in a 2-column grid and save to a PNG file
png("./results/parental.plots_resid_fit.png", width = 1600, height = 1200)
...
write_csv(results_main_effect_cld, "./results/parental.posthoc.gene.csv")
write_csv(results_simple_effect_stars, "./results/parental.posthoc.interaction.csv")
...
"total.mass","G2","c",
"total.mass","G5","c",
"total.leaf.mass","G3","a",
"total.leaf.mass","G4","a",
"total.leaf.mass","G1","b",
"total.leaf.mass","G6","b",
"total.leaf.mass","G5","b",
"total.leaf.mass","G2","b",
"stem.mass","G4","a",
"stem.mass","G3","ab",
"stem.mass","G1","bc",
"stem.mass","G6","cd",
...
"stem.length","G4","c",
"stem.length","G5","c",
"total.leaf.area","G4","a",
"total.leaf.area","G3","b",
"total.leaf.area","G1","b",
"total.leaf.area","G6","b",
"total.leaf.area","G5","b",
"total.leaf.area","G2","b",
"mla","G4","a",
"mla","G1","b",
"mla","G5","b",
"mla","G6","b",
